import{a as l,j as e,B as _,h as z,C as Y,c as Q,at as k,au as X,S as Z,D as q,X as J,k as ee,t as te,aD as T,ak as re,aE as se}from"./vendor-ui-B4bzZxub.js";import{b as ae,u as oe,c as le,C as ne,s as ce,p as h,i as $,P as ie}from"./index-BH29KkdH.js";import"./vendor-react-C8dRaBk7.js";import"./vendor-utils-DAhNZW45.js";const he=()=>{const{id:f}=ae(),{machines:p,writeupMachineId:F,setWriteupMachineId:w,updateMachine:b,soundEnabled:m,globalVars:y}=oe();l.useEffect(()=>{f&&p.some(t=>t.id===f)&&w(f)},[f,p,w]);const r=p.find(t=>t.id===F)||p[0],[P,S]=l.useState(!1),[O,E]=l.useState(!1),[i,x]=l.useState(""),[R,D]=l.useState(!1),[N,L]=l.useState(""),[v,A]=l.useState(""),[de,pe]=l.useState(null);l.useEffect(()=>{const t=setTimeout(()=>{A(N)},150);return()=>clearTimeout(t)},[N]);const g=l.useMemo(()=>v.trim()?ce(v,"ALL").slice(0,20):r?le(r,20):ne.slice(0,20),[v,r]),M=t=>{if(!r)return;const a={...y,targetIp:r.ip||y.targetIp},o=t.commands&&t.commands.length>0?`
\`\`\`bash
# ${t.title}
