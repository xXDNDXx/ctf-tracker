import{a as p,j as e,z as T,h as W,C as B,c as L,ar as A,S as M,D as U,az as k,aj as V,aq as G,aA as z}from"./vendor-ui-k8TjXgJS.js";import{a as H,u as K,p as f,P as Y}from"./index-CoXBZMaQ.js";import"./vendor-react-1_ibb0q1.js";import"./vendor-utils-DwU2QVSh.js";const X=()=>{const{id:x}=H(),{machines:i,writeupMachineId:E,setWriteupMachineId:u,updateMachine:b,soundEnabled:m}=K();p.useEffect(()=>{x&&i.some(t=>t.id===x)&&u(x)},[x,i,u]);const r=i.find(t=>t.id===E)||i[0],[S,w]=p.useState(!1),[C,j]=p.useState(!1),[l,d]=p.useState(""),v=t=>{const a=new Date().toISOString().slice(0,10),o=t.tags.length>0?t.tags.join(", "):"ctf, pentest, writeup";return`---
