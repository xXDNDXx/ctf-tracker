import{a as l,j as e,z as K,h as _,C as Y,c as Q,ar as S,as as X,S as Z,D as q,X as J,i as ee,s as te,aA as T,aj as re,aB as se}from"./vendor-ui-DEQdev4l.js";import{b as ae,u as oe,c as le,C as ne,s as ce,p as h,i as $,P as ie}from"./index-CmV3Zjzp.js";import"./vendor-react-CJuRcchx.js";import"./vendor-utils-BTDfHNxJ.js";const he=()=>{const{id:f}=ae(),{machines:p,writeupMachineId:F,setWriteupMachineId:w,updateMachine:b,soundEnabled:m,globalVars:y}=oe();l.useEffect(()=>{f&&p.some(t=>t.id===f)&&w(f)},[f,p,w]);const r=p.find(t=>t.id===F)||p[0],[P,k]=l.useState(!1),[O,E]=l.useState(!1),[i,x]=l.useState(""),[R,I]=l.useState(!1),[N,A]=l.useState(""),[v,L]=l.useState(""),[de,pe]=l.useState(null);l.useEffect(()=>{const t=setTimeout(()=>{L(N)},150);return()=>clearTimeout(t)},[N]);const g=l.useMemo(()=>v.trim()?ce(v,"ALL").slice(0,20):r?le(r,20):ne.slice(0,20),[v,r]),M=t=>{if(!r)return;const a={...y,targetIp:r.ip||y.targetIp},o=t.commands&&t.commands.length>0?`
\`\`\`bash
# ${t.title}
