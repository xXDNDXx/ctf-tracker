import{a as l,j as e,A as _,h as z,C as Y,c as Q,as as k,at as X,S as Z,D as q,X as J,k as ee,t as te,aD as T,ak as re,aE as se}from"./vendor-ui-D7mdMaHR.js";import{b as ae,u as oe,c as le,C as ne,s as ce,p as h,i as $,P as ie}from"./index-BwY1Lp4x.js";import"./vendor-react-CDZr0bPa.js";import"./vendor-utils-BQqzYLuo.js";const he=()=>{const{id:f}=ae(),{machines:p,writeupMachineId:F,setWriteupMachineId:w,updateMachine:b,soundEnabled:m,globalVars:y}=oe();l.useEffect(()=>{f&&p.some(t=>t.id===f)&&w(f)},[f,p,w]);const r=p.find(t=>t.id===F)||p[0],[P,S]=l.useState(!1),[O,E]=l.useState(!1),[i,x]=l.useState(""),[R,D]=l.useState(!1),[N,A]=l.useState(""),[v,L]=l.useState(""),[de,pe]=l.useState(null);l.useEffect(()=>{const t=setTimeout(()=>{L(N)},150);return()=>clearTimeout(t)},[N]);const g=l.useMemo(()=>v.trim()?ce(v,"ALL").slice(0,20):r?le(r,20):ne.slice(0,20),[v,r]),M=t=>{if(!r)return;const a={...y,targetIp:r.ip||y.targetIp},o=t.commands&&t.commands.length>0?`
\`\`\`bash
# ${t.title}
...
${o}`,d=i+j;x(d),b(r.id,{writeupMarkdown:d}),m&&h("root")},I=t=>{const a=new Date().toISOString().slice(0,10),o=t.tags.length>0?t.tags.join(", "):"ctf, pentest, writeup";return`---
