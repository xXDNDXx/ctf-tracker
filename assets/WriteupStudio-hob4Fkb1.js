import{a as l,j as e,E as _,i as z,C as Y,c as Q,av as k,aw as X,h as Z,D as q,X as J,l as ee,u as te,aH as T,an as re,aI as se}from"./vendor-ui-aimRkHKo.js";import{c as ae,a as oe,d as le,C as ne,s as ce,p as h,i as $,P as ie}from"./index-CUKWM2CZ.js";import"./vendor-react-Dq7tsDnx.js";import"./vendor-utils-Bap8ptmo.js";const he=()=>{const{id:f}=ae(),{machines:p,writeupMachineId:F,setWriteupMachineId:j,updateMachine:b,soundEnabled:m,globalVars:y}=oe();l.useEffect(()=>{f&&p.some(t=>t.id===f)&&j(f)},[f,p,j]);const r=p.find(t=>t.id===F)||p[0],[P,S]=l.useState(!1),[O,E]=l.useState(!1),[i,x]=l.useState(""),[I,R]=l.useState(!1),[N,L]=l.useState(""),[v,A]=l.useState(""),[de,pe]=l.useState(null);l.useEffect(()=>{const t=setTimeout(()=>{A(N)},150);return()=>clearTimeout(t)},[N]);const g=l.useMemo(()=>v.trim()?ce(v,"ALL").slice(0,20):r?le(r,20):ne.slice(0,20),[v,r]),M=t=>{if(!r)return;const a={...y,targetIp:r.ip||y.targetIp},o=t.commands&&t.commands.length>0?`
\`\`\`bash
# ${t.title}
...
${o}`,d=i+w;x(d),b(r.id,{writeupMarkdown:d}),m&&h("root")},D=t=>{const a=new Date().toISOString().slice(0,10),o=t.tags.length>0?t.tags.join(", "):"ctf, pentest, writeup";return`---
