import{a as p,j as e,y as O,h as W,C as L,c as B,ak as A,S as M,D as U,at as k,aa as V,aj as G,au as z}from"./vendor-ui-AaaSS2WL.js";import{a as H,u as K,p as f,P as Y}from"./index-CltHS5Cz.js";import"./vendor-react-D1WCsB1m.js";import"./vendor-utils-BNtl0IuK.js";const X=()=>{const{id:x}=H(),{machines:i,writeupMachineId:E,setWriteupMachineId:u,updateMachine:b,soundEnabled:m}=K();p.useEffect(()=>{x&&i.some(t=>t.id===x)&&u(x)},[x,i,u]);const r=i.find(t=>t.id===E)||i[0],[S,w]=p.useState(!1),[C,j]=p.useState(!1),[l,d]=p.useState(""),v=t=>{const a=new Date().toISOString().slice(0,10),o=t.tags.length>0?t.tags.join(", "):"ctf, pentest, writeup";return`---
