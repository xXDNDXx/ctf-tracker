import{a as p,j as e,y as T,h as W,C as B,c as L,ar as A,S as M,D as U,az as k,ai as V,aq as G,aA as z}from"./vendor-ui-CacpaMGv.js";import{a as H,u as K,p as f,P as Y}from"./index-BsF86k7O.js";import"./vendor-react-BcfVLUEN.js";import"./vendor-utils-CRFgqJY_.js";const X=()=>{const{id:x}=H(),{machines:i,writeupMachineId:E,setWriteupMachineId:u,updateMachine:b,soundEnabled:m}=K();p.useEffect(()=>{x&&i.some(t=>t.id===x)&&u(x)},[x,i,u]);const r=i.find(t=>t.id===E)||i[0],[S,w]=p.useState(!1),[C,j]=p.useState(!1),[l,d]=p.useState(""),v=t=>{const a=new Date().toISOString().slice(0,10),o=t.tags.length>0?t.tags.join(", "):"ctf, pentest, writeup";return`---
