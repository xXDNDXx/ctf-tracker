import{a as p,j as e,y as T,h as W,C as B,c as L,ao as A,S as M,D as U,av as k,af as V,an as G,aw as z}from"./vendor-ui-DCll0ZOV.js";import{a as H,u as K,p as f,P as Y}from"./index-HWCkEbst.js";import"./vendor-react-C11qQ-O8.js";import"./vendor-utils-CPdO9B65.js";const X=()=>{const{id:x}=H(),{machines:i,writeupMachineId:E,setWriteupMachineId:u,updateMachine:b,soundEnabled:m}=K();p.useEffect(()=>{x&&i.some(t=>t.id===x)&&u(x)},[x,i,u]);const r=i.find(t=>t.id===E)||i[0],[S,w]=p.useState(!1),[C,j]=p.useState(!1),[l,d]=p.useState(""),v=t=>{const a=new Date().toISOString().slice(0,10),o=t.tags.length>0?t.tags.join(", "):"ctf, pentest, writeup";return`---
