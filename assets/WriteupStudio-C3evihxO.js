import{a as p,j as e,z as T,h as B,C as W,c as L,as as A,S as M,D as U,aA as k,aj as V,ar as G,aB as z}from"./vendor-ui-DEQdev4l.js";import{a as H,u as K,p as f,P as Y}from"./index-CTKiIN1I.js";import"./vendor-react-CJuRcchx.js";import"./vendor-utils-BTDfHNxJ.js";const X=()=>{const{id:x}=H(),{machines:i,writeupMachineId:E,setWriteupMachineId:u,updateMachine:b,soundEnabled:m}=K();p.useEffect(()=>{x&&i.some(t=>t.id===x)&&u(x)},[x,i,u]);const r=i.find(t=>t.id===E)||i[0],[S,w]=p.useState(!1),[C,j]=p.useState(!1),[l,d]=p.useState(""),v=t=>{const a=new Date().toISOString().slice(0,10),o=t.tags.length>0?t.tags.join(", "):"ctf, pentest, writeup";return`---
