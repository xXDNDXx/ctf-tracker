          ...
          <div className="p-2.5 rounded-xl bg-gradient-to-r from-emerald-50 via-slate-50 dark:via-cyber-card to-cyan-50 dark:from-cyber-emerald/10 dark:to-cyber-cyan/10 border border-emerald-300 dark:border-cyber-emerald/40 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              <a
                ...
                className="group/btn flex items-center justify-center gap-1.5 py-2 px-2 rounded-lg bg-emerald-50 hover:bg-emerald-600 text-emerald-800 hover:text-white dark:bg-emerald-950/40 dark:hover:bg-cyber-emerald dark:text-emerald-300 dark:hover:text-slate-950 border border-emerald-300 hover:border-emerald-600 dark:border-emerald-500/40 dark:hover:border-cyber-emerald transition-all text-xs font-medium shadow-2xs active:scale-95"
                title="Daniel Dayan's Official Portfolio"
              >
                <Globe className="w-3.5 h-3.5 flex-shrink-0 group-hover/btn:scale-110 transition-transform" />
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group/btn flex items-center justify-center gap-1.5 py-2 px-2 rounded-lg bg-[#0A66C2]/10 hover:bg-[#0A66C2] text-[#0A66C2] hover:text-white dark:bg-[#0077B5]/15 dark:hover:bg-[#0A66C2] dark:text-[#38bdf8] dark:hover:text-white border border-[#0A66C2]/25 hover:border-[#0A66C2] dark:border-[#0077B5]/40 dark:hover:border-[#0A66C2] transition-all text-xs font-medium shadow-2xs active:scale-95"
                title="Daniel Dayan LinkedIn Profile"
              >
                <svg className="w-3.5 h-3.5 fill-current flex-shrink-0 text-[#0A66C2] dark:text-[#38bdf8] group-hover/btn:text-white dark:group-hover/btn:text-white group-hover/btn:scale-110 transition-transform" viewBox="0 0 24 24"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 10.9v8.37H9.2V10.9H6.46M7.83 6.7a1.6 1.6 0 1 0 0 3.2 1.6 1.6 0 0 0 0-3.2Z"/></svg>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group/btn flex items-center justify-center gap-1.5 py-2 px-2 rounded-lg bg-slate-100 hover:bg-slate-900 text-slate-800 hover:text-white dark:bg-white/10 dark:hover:bg-white dark:text-slate-200 dark:hover:text-slate-950 border border-slate-300 hover:border-slate-900 dark:border-white/20 dark:hover:border-white transition-all text-xs font-medium shadow-2xs active:scale-95"
                title="Daniel Dayan on GitHub"
              >
                <svg className="w-3.5 h-3.5 fill-current flex-shrink-0 text-slate-800 dark:text-slate-200 group-hover/btn:text-white dark:group-hover/btn:text-slate-950 group-hover/btn:scale-110 transition-transform" viewBox="0 0 24 24"><path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.53 1.032 1.53 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"/></svg>
