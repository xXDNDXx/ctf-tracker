...
export const OsIcon: React.FC<OsIconProps> = ({ os, className = 'w-3.5 h-3.5' }) => {
  switch (os) {
    ...
    case 'Active Directory':
      return (
        <svg viewBox="0 0 24 24" className={className} fill="none" stroke="#A855F7" strokeWidth="1.8" xmlns="http://www.w3.org/2000/svg">
          {/* Microsoft Active Directory Domain Hierarchy Tree */}
          <rect x="8" y="2" width="8" height="5" rx="1.2" fill="rgba(168,85,247,0.2)" stroke="#A855F7" />
          <path d="M12 7v5M5 12h14M5 12v3M19 12v3" stroke="#A855F7" strokeLinecap="round" />
          <rect x="2" y="15" width="6" height="5" rx="1.2" fill="rgba(168,85,247,0.2)" stroke="#A855F7" />
          <rect x="16" y="15" width="6" height="5" rx="1.2" fill="rgba(168,85,247,0.2)" stroke="#A855F7" />
        </svg>
      );
...
export const OsBadge: React.FC<OsBadgeProps> = ({
  os,
  size = 'xs',
  showLabel = true,
  className = '',
  ...
  const getTheme = () => {
    switch (os) {
      case 'Linux':
        return 'text-amber-300 bg-amber-950/20 border-amber-500/30';
      case 'Windows':
        return 'text-sky-300 bg-sky-950/20 border-sky-500/30';
      case 'Active Directory':
        return 'text-purple-300 bg-purple-950/20 border-purple-500/30';
      default:
        return 'text-cyber-muted bg-cyber-bg border-cyber-border';
    }
  };
