...
export const KeyboardShortcutsModal: React.FC = () => {
  ...
  return (
    <div
      className="fixed inset-0 z-[125] flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md font-mono"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 id="shortcuts-modal-title" className="text-base font-bold text-white tracking-wide">
