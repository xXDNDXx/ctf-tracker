...
export const OperatorFlexCardModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/85 backdrop-blur-md animate-fade-in font-mono" onClick={() => setFlexCardModalOpen(false)}>
      <div 
        className="w-full max-w-4xl max-h-[95vh] flex flex-col rounded-2xl border border-emerald-500/50 dark:border-cyber-emerald/50 bg-white dark:bg-[#0b101c] shadow-[0_0_50px_rgba(16,185,129,0.25)] overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex-shrink-0 flex items-center justify-between border-b border-slate-200 dark:border-cyber-border/80 px-5 py-3.5 bg-slate-50 dark:bg-[#080c14]">
          <div className="flex items-center gap-2.5">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 dark:bg-cyber-emerald animate-pulse shadow-glow-emerald" />
            <Award className="w-4 h-4 text-emerald-600 dark:text-cyber-emerald" />
            <span className="font-bold text-emerald-700 dark:text-cyber-emerald tracking-wide text-xs uppercase">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 flex flex-col items-center space-y-4">
          <div className="relative w-full max-w-3xl rounded-xl border border-emerald-500/40 dark:border-cyber-emerald/40 overflow-hidden shadow-2xl bg-black">
            <canvas 
              ref={canvasRef} 
          ...
          <p className="text-slate-600 dark:text-cyber-muted text-xs text-center max-w-xl">
        ...
        <div className="px-5 py-3.5 bg-slate-50 dark:bg-[#080c14] border-t border-slate-200 dark:border-cyber-border/80 flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2">
            <button
              onClick={handleDownloadPng}
              className="px-4 py-2 rounded-xl bg-emerald-600 dark:bg-cyber-emerald text-white dark:text-black font-extrabold hover:bg-emerald-500 dark:hover:bg-cyber-emerald/90 transition-all flex items-center gap-2 shadow-glow-emerald"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-white dark:bg-cyber-card border border-slate-200 dark:border-cyber-border hover:border-cyan-500 text-slate-800 dark:text-white hover:text-cyan-700 dark:hover:text-cyber-cyan transition-all flex items-center gap-2"
            >
              {copied ? (
                <>
                  <Check className="w-4 h-4 text-emerald-600 dark:text-cyber-emerald" />
                  <span className="text-emerald-700 dark:text-cyber-emerald font-bold">COPIED TO CLIPBOARD!</span>
                </>
              ) : (
                <>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-[#0077B5]/15 dark:bg-[#0077B5]/20 hover:bg-[#0077B5]/25 dark:hover:bg-[#0077B5]/35 border border-[#0077B5]/40 dark:border-[#0077B5]/50 text-slate-900 dark:text-white font-bold transition-all flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-slate-200/80 dark:bg-white/10 hover:bg-slate-300 dark:hover:bg-white/20 border border-slate-300 dark:border-white/30 text-slate-900 dark:text-white font-bold transition-all flex items-center gap-1.5"
            >
