      ...
      >
        ...
        <div className="flex-shrink-0 flex items-center justify-between border-b border-cyber-border p-4 bg-cyber-bg/95">
          <div className="flex items-center gap-2.5">
            ...
            <h3 id="backup-modal-title" className="text-base font-bold text-white tracking-wide">
          ...
          {activeTab === 'backup' ? (
            <>
              ...
              <div className="p-4 rounded-xl bg-gradient-to-r from-cyber-emerald/10 via-cyber-card to-cyber-bg border border-cyber-emerald/40 space-y-3.5 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 font-mono text-xs">
                  <div className="relative">
                    <input
                      ...
                      className="w-full p-2 rounded bg-cyber-bg border border-cyber-border text-white placeholder-cyber-muted text-xs focus:outline-none focus:border-cyber-emerald pr-8"
                    />
                    <button
                      type="button"
                  ...
                  <div>
                    <input
                      ...
                      className="w-full p-2 rounded bg-cyber-bg border border-cyber-border text-white placeholder-cyber-muted text-xs focus:outline-none focus:border-cyber-emerald"
                    />
                  </div>
                </div>

                {encExportError && (
                  <div className="flex items-center gap-2 text-cyber-crimson text-xs font-mono">
                ...
                <div className="flex items-center justify-between flex-wrap gap-2 pt-1">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-cyber-emerald text-black font-bold hover:bg-emerald-400 transition-all shadow-glow-emerald disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    <Lock className="w-3.5 h-3.5" />
                    <span>{isExportingEnc ? 'Encrypting Vault...' : 'Download Encrypted Vault (.zerobox.enc)'}</span>
                  </button>
                  <span className="text-[10px] text-cyber-muted italic">
              ...
              <div className="p-3.5 rounded-lg bg-cyber-bg border border-cyber-border space-y-3">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div>
                    <span className="font-bold text-white text-sm block">Team Sharing & JSON Export</span>
              ...
              <div className="p-3.5 rounded-lg bg-cyber-bg border border-cyber-border space-y-3">
                ...
                {pendingEncryptedBuffer ? (
                  <div className="p-3.5 rounded-lg bg-amber-500/10 border border-amber-500/40 space-y-3 font-mono">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-[10px] text-cyber-muted hover:text-white"
                      >
                        Cancel / Change File ✕
                      </button>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="relative flex-1">
                        <input
                          ...
                          className="w-full p-2.5 rounded bg-cyber-card border border-amber-500/50 text-white placeholder-cyber-muted text-xs focus:outline-none focus:border-amber-400 pr-8"
                        />
                        <button
                          type="button"
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-lg bg-cyber-emerald text-black font-bold hover:bg-emerald-400 transition-all shadow-glow-emerald disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1.5"
                      >
