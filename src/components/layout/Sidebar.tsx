    ...
    >
      ...
      {!collapsed ? (
        <div className="p-3 border-t border-cyber-border bg-cyber-card/40 font-mono text-xs">
          ...
          {/* Lead Operator Profile Card */}
          <div className="mt-2.5 pt-2 border-t border-cyber-border/70 flex items-center justify-between">
            <div className="flex items-center gap-1.5 min-w-0">
              <div className="w-6 h-6 rounded-full bg-cyber-emerald/20 border border-cyber-emerald flex items-center justify-center text-[10px] font-bold text-cyber-emerald flex-shrink-0">
                DD
              </div>
              <div className="truncate">
                <div className="text-[11px] font-bold text-white leading-tight truncate">Daniel Dayan</div>
                <div className="text-[9px] text-cyber-muted leading-none">Security Operator</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              <a
                ...
                className="p-1 rounded bg-cyber-bg hover:bg-[#0077B5]/20 border border-cyber-border hover:border-[#0077B5] text-cyber-muted hover:text-[#0077B5] transition-all"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-1 rounded bg-cyber-bg hover:bg-white/10 border border-cyber-border hover:border-cyber-emerald text-cyber-muted hover:text-white transition-all"
