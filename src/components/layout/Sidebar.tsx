...
export const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    },
    {
      id: 'warroom',
      path: '/warroom',
      label: 'War Room (Ops Deck)',
      icon: Radio,
      badge: 'LIVE',
      badgeColor: 'text-rose-600 dark:text-rose-400 bg-rose-100 dark:bg-rose-500/15 border-rose-300 dark:border-rose-500/30',
      sublabel: 'Dual-Pane Ops Deck',
    },
  ] as const;
